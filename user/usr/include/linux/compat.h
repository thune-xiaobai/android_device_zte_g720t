...
asmlinkage long compat_sys_ustat(unsigned dev, struct compat_ustat *u32);
...
asmlinkage long compat_sys_execve(const char *filename, const compat_uptr_t *argv,
		     const compat_uptr_t *envp);

asmlinkage long compat_sys_select(int n, compat_ulong_t *inp,
		compat_ulong_t *outp, compat_ulong_t *exp,
		struct compat_timeval *tvp);

asmlinkage long compat_sys_old_select(struct compat_sel_arg_struct *arg);
...
static __inline__ int compat_timeval_compare(struct compat_timeval *lhs,
...
static __inline__ int compat_timespec_compare(struct compat_timespec *lhs,
...
asmlinkage long compat_sys_gettimeofday(struct compat_timeval *tv,
		struct timezone *tz);
asmlinkage long compat_sys_settimeofday(struct compat_timeval *tv,
		struct timezone *tz);
...
asmlinkage long compat_sys_lookup_dcookie(u32, u32, char *, size_t);
/*
...
asmlinkage long compat_sys_utime(const char *filename,
...
asmlinkage long compat_sys_time(compat_time_t *tloc);
asmlinkage long compat_sys_stime(compat_time_t *tptr);
...
asmlinkage long compat_sys_utimes(const char *filename,
				  struct compat_timeval *t);
asmlinkage long compat_sys_newstat(const char *filename,
				   struct compat_stat *statbuf);
asmlinkage long compat_sys_newlstat(const char *filename,
				    struct compat_stat *statbuf);
...
asmlinkage long compat_sys_newfstat(unsigned int fd,
				    struct compat_stat *statbuf);
asmlinkage long compat_sys_statfs(const char *pathname,
				  struct compat_statfs *buf);
asmlinkage long compat_sys_fstatfs(unsigned int fd,
				   struct compat_statfs *buf);
asmlinkage long compat_sys_statfs64(const char *pathname,
				    compat_size_t sz,
...
asmlinkage long compat_sys_io_submit(aio_context_t ctx_id, int nr,
				     u32 *iocb);
asmlinkage long compat_sys_mount(const char *dev_name,
				 const char *dir_name,
...
asmlinkage long compat_sys_getdents64(unsigned int fd,
				      ...
				      unsigned int count);
asmlinkage long compat_sys_vmsplice(int fd, const struct compat_iovec *,
				    unsigned int nr_segs, unsigned int flags);
asmlinkage long compat_sys_open(const char *filename, int flags,
				umode_t mode);
asmlinkage long compat_sys_openat(int dfd, const char *filename,
				  int flags, umode_t mode);
asmlinkage long compat_sys_open_by_handle_at(int mountdirfd,
					     struct file_handle *handle,
					     int flags);
asmlinkage long compat_sys_truncate(const char *, compat_off_t);
asmlinkage long compat_sys_ftruncate(unsigned int, compat_ulong_t);
asmlinkage long compat_sys_pselect6(int n, compat_ulong_t *inp,
				    compat_ulong_t *outp,
				    compat_ulong_t *exp,
				    struct compat_timespec *tsp,
				    void *sig);
asmlinkage long compat_sys_ppoll(struct pollfd *ufds,
				 unsigned int nfds,
				 struct compat_timespec *tsp,
				 const compat_sigset_t *sigmask,
				 compat_size_t sigsetsize);
...
asmlinkage long compat_sys_get_mempolicy(int *policy,
					 compat_ulong_t *nmask,
					 compat_ulong_t maxnode,
					 compat_ulong_t addr,
					 compat_ulong_t flags);
asmlinkage long compat_sys_set_mempolicy(int mode, compat_ulong_t *nmask,
					 compat_ulong_t maxnode);
...
asmlinkage long compat_sys_sendmsg(int fd, struct compat_msghdr *msg,
				   unsigned flags);
asmlinkage long compat_sys_sendmmsg(int fd, struct compat_mmsghdr *mmsg,
				    unsigned vlen, unsigned int flags);
asmlinkage long compat_sys_recvmsg(int fd, struct compat_msghdr *msg,
				   unsigned int flags);
asmlinkage long compat_sys_recv(int fd, void *buf, size_t len,
				unsigned flags);
asmlinkage long compat_sys_recvfrom(int fd, void *buf, size_t len,
			    unsigned flags, struct sockaddr *addr,
			    int *addrlen);
asmlinkage long compat_sys_recvmmsg(int fd, struct compat_mmsghdr *mmsg,
				    unsigned vlen, unsigned int flags,
				    struct compat_timespec *timeout);
...
asmlinkage long compat_sys_clock_nanosleep(clockid_t which_clock, int flags,
					   ...
					   struct compat_timespec *rmtp);
asmlinkage long compat_sys_rt_sigtimedwait(compat_sigset_t *uthese,
		struct compat_siginfo *uinfo,
		struct compat_timespec *uts, compat_size_t sigsetsize);
asmlinkage long compat_sys_rt_sigsuspend(compat_sigset_t *unewset,
					 compat_size_t sigsetsize);
asmlinkage long compat_sys_rt_sigprocmask(int how, compat_sigset_t *set,
					  compat_sigset_t *oset,
					  compat_size_t sigsetsize);
asmlinkage long compat_sys_rt_sigpending(compat_sigset_t *uset,
					 compat_size_t sigsetsize);
...
asmlinkage long compat_sys_rt_sigqueueinfo(compat_pid_t pid, int sig,
				struct compat_siginfo *uinfo);
asmlinkage long compat_sys_sysinfo(struct compat_sysinfo *info);
asmlinkage long compat_sys_ioctl(unsigned int fd, unsigned int cmd,
				 unsigned long arg);
asmlinkage long compat_sys_futex(u32 *uaddr, int op, u32 val,
...
asmlinkage long compat_sys_mq_open(const char *u_name,
...
asmlinkage long compat_sys_sysctl(struct compat_sysctl_args *args);
